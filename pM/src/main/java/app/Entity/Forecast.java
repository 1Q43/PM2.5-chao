...
public class Forecast {
    ...
    public void debugs(String tag){
        Log.e(tag,"userId:"+String.valueOf(userid)+" outdoor:"
        + outdoor + " indoor:"+indoor+" 室内总吸入量:"+ventilationVolIndoor+
        " 室外总吸入量:"+ventilationVolOutdoor);
    }
